...
public static class DbInitializer
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            logger.LogWarning(
                "Nenhum usuário no banco e SeedAdmin.Enabled=false. " +
                "Crie um usuário manualmente ou habilite SeedAdmin em desenvolvimento.");
            return;
        }
        ...
        logger.LogInformation("Usuário inicial criado: {Username}", username);
    }
}
